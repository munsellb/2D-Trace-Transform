...
int main(int argc, const char *argv[]) {
	...
	if ( argc != 11 ) {
		...
		std::cout<<""<<std::endl;
		std::cout<<""<<std::endl;
		std::cout<<"Trace Transform requires 5 arguments!"<<std::endl;
		std::cout<<""<<std::endl;
		std::cout<<"-------------------------------------------"<<std::endl;
		std::cout<<"Usage: TraceTransform -input -output -func -histeq -color"<<std::endl;
		std::cout<<"-------------------------------------------"<<std::endl;
		...
		std::cout<<""<<std::endl;
		std::cout<<"ex:  TraceTransform -input image.jpg -output trace.dat -func 0 -histeq 1 -color 1"<<std::endl;
		std::cout<<""<<std::endl;
		std::cout<<""<<std::endl;
		return -1;
